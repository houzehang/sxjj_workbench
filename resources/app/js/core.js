...
Core.create = function(obj,opt){    
    ...
    if(typeof(obj)==='string'){
        ...
        FuncMap[options.url] && FuncMap[options.url]();
...
var GetTaskSystem = function(obj){
    if(!_cache.TaskSystem){
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;bottom:30px;display:none"><ul><li><a menu="close" target="_blank" href="./extends/electron_form.html">根目录设置</a></li><li><a menu="close" href="javascript:;">欢迎添加！</a></li></ul></div>');
